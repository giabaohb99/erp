# ═══════════════════════════════════════════════════════════════════════════════
#                    BaoERP MRP UI REDESIGN - THỢ XÂY MASTER PROMPT
...
Kiến trúc sư và Chủ nhà đã **THỐNG NHẤT** bản thiết kế UI mới cho BaoERP MRP.
...
Hỏi Chủ nhà:
```
"Cho tôi đường dẫn đến thư mục dự án BaoERP MRP trên máy của bạn."
```
