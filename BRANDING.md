# BaoERP Platform — Hướng dẫn Cá nhân hoá Thương hiệu / Branding Customization Guide

## Tổng quan / Overview

BaoERP Platform là hệ thống ERP mã nguồn mở, được thiết kế để doanh nghiệp dễ dàng cá nhân hoá thương hiệu (white-label). Mọi thông tin thương hiệu được quản lý tập trung tại package `@vierp/branding`.

BaoERP Platform is an open-source ERP system designed for easy white-label customization. All branding information is centrally managed in the `@vierp/branding` package.
...
console.log(brand.platform.name);  // "BaoERP Platform"
...
*Tài liệu này được tạo tự động bởi BaoERP Platform Debranding Tool.*
*This document was auto-generated by the BaoERP Platform Debranding Tool.*
